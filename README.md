...
Red Hat OpenShift 5: First Look Lab
...
1. Open in DevSpaces: `https://devspaces.apps.ocpv-infra02.wdc07.infra.demo.redhat.com#https://github.com/rhpds/ocp5-first-look-lab`
...
2. Clone the repo:
   ```
   git clone https://github.com/rhpds/ocp5-first-look-lab
   ```
3. `cd ocp5-first-look-lab`
